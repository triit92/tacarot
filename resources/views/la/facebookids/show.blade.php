...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-2">
			<div class="row">
				...
				<div class="col-md-9 hidden">
					<h4 class="name">{{ $facebookid->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Facebookids", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/facebookids/'.$facebookid->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Facebookids", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.facebookids.destroy', $facebookid->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/facebookids') }}" data-toggle="tooltip" data-placement="right" title="Back to Facebookids"><i class="fa fa-chevron-left"></i></a></li>
