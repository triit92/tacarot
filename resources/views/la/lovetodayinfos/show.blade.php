...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $lovetodayinfo->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Lovetodayinfos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/lovetodayinfos/'.$lovetodayinfo->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Lovetodayinfos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.lovetodayinfos.destroy', $lovetodayinfo->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/lovetodayinfos') }}" data-toggle="tooltip" data-placement="right" title="Back to Lovetodayinfos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'ngay')
						@la_display($module, 'bachduong')
						@la_display($module, 'kimnguu')
						@la_display($module, 'songtu')
						@la_display($module, 'cugiai')
						@la_display($module, 'sutu')
						@la_display($module, 'xunu')
						@la_display($module, 'thienbinh')
						@la_display($module, 'hocap')
						@la_display($module, 'nhanma')
						@la_display($module, 'maket')
						@la_display($module, 'baobinh')
						@la_display($module, 'songngu')
					</div>
				</div>
			</div>
		</div>
