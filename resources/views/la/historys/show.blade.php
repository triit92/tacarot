...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $history->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Historys", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/historys/'.$history->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Historys", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.historys.destroy', $history->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/historys') }}" data-toggle="tooltip" data-placement="right" title="Back to Historys"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'dayofyear')
						@la_display($module, 'value_one')
						@la_display($module, 'type_one')
						@la_display($module, 'value_two')
						@la_display($module, 'type_two')
						@la_display($module, 'value_three')
						@la_display($module, 'type_three')
						@la_display($module, 'value_four')
						@la_display($module, 'type_four')
						@la_display($module, 'detail_result')
					</div>
				</div>
			</div>
		</div>
